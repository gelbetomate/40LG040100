...
public:
  ...
  // Schaltpunkt Erdwaermetauscher Winter lesen/schreiben
  ...
  // Waermepumpe frei (freigegeben (1) oder aus (0)) lesen/schreiben
  static constexpr const char *WP = "WP";

  // Pausezeit fuer Druckabbau bei automatischer Umschaltung lesen/schreiben
  static constexpr const char *PA = "PA";

  // Identifikation lesen
  static constexpr const char *II = "II";

  // Messwert, RWZ aktl., Aktuelle Rueckwaermzahl in %
  ...
  // Parameter, ERDluft +S1, Drehzahlerhoehung Zuluftventilator Stufe 1, wenn
  // Erdwaermetauscher ein (0% bis 40%)
  static constexpr const char *E1 = "E1";

  // Parameter, ERDluft +S2, Drehzahlerhoehung Zuluftventilator Stufe 2, wenn
  // Erdwaermetauscher ein (0% bis 40%)
  static constexpr const char *E2 = "E2";

  // Parameter, ERDluft +S3, Drehzahlerhoehung Zuluftventilator Stufe 3, wenn
  // Erdwaermetauscher ein (0% bis 40%)
  static constexpr const char *E3 = "E3";

  // Parameter, LuflREDUK, Luftwechsel um 3% reduziert ab Aussentemp. ...°C
  // (-20°C bis +10°C)
...
using WR3223Commands = LG040100Registers;
} // namespace lg040100
