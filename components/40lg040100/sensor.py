...
REFERENCE_PROFILE_SENSORS_CUSTOM = {
    ...
    "lg250": [
        {CONF_COMMAND: "T1", CONF_NAME: "LG250 T1 Aussenluft - Verdampfertemperatur", CONF_UNIT_OF_MEASUREMENT: UNIT_CELSIUS, CONF_ACCURACY_DECIMALS: 1, CONF_UPDATE_INTERVAL: "30s"},
        {CONF_COMMAND: "T2", CONF_NAME: "LG250 T2 Zulufttemperatur", CONF_UNIT_OF_MEASUREMENT: UNIT_CELSIUS, CONF_ACCURACY_DECIMALS: 1, CONF_UPDATE_INTERVAL: "30s"},
