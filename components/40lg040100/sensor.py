...
SENSOR_COMMANDS = {
    # Temperatur-Sensoren
    "T1": ("T1 Temperatur Register", UNIT_CELSIUS, DEVICE_CLASS_TEMPERATURE),
...
REFERENCE_PROFILE_SENSORS_CUSTOM = {
    ...
    "lg250": [
        ...
        {CONF_COMMAND: "T3", CONF_NAME: "LG250 T3 Aussentemperatur (Aussenluft)", CONF_UNIT_OF_MEASUREMENT: UNIT_CELSIUS, CONF_ACCURACY_DECIMALS: 1, CONF_UPDATE_INTERVAL: "30s"},
        {CONF_COMMAND: "T4", CONF_NAME: "LG250 T4 Ablufttemperatur Raum (Abluft)", CONF_UNIT_OF_MEASUREMENT: UNIT_CELSIUS, CONF_ACCURACY_DECIMALS: 1, CONF_UPDATE_INTERVAL: "30s"},
